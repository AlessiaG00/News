import logging
from src.scrapers import bbc, corriere, guardian, NYT, il_post, openai, repubblica, sole24ore, anthropic, google_deepmind, google_research, deepseek
